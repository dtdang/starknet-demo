...
def main():
    ...
    print(factory_declaration.class_hash)
    ...
    print(actual_balance == expected_balance)
    ...
    print(factory.create_my_contract)
    ...
    print(new_contract_instance.get_balance(account) == balance_pre_call + 9)
